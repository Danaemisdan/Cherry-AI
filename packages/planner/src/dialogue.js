...
const STRATEGIES = {
  ...
  marketing: {
    ...
    actions: ['engage_post', 'follow_user', 'auto_post', 'like_ai_comment', 'upload_youtube_video', 'upload_youtube_short', 'create_youtube_post'],
  ...
  research: {
    ...
    platforms: ['research', 'instagram', 'linkedin', 'twitter', 'youtube'],
  },
  monitor: {
    id: 'monitor',
  ...
  viral: {
    ...
    actions: ['auto_post', 'engage_post', 'follow_user', 'like_ai_comment', 'upload_youtube_video', 'upload_youtube_short', 'create_youtube_post'],
    platforms: ['instagram', 'linkedin', 'twitter', 'facebook', 'youtube'],
  },
};
...
export class DialogueEngine {
  ...
  formatActionLabel(action) {
    const labels = {
      ...
      upload_youtube_short: 'Upload YouTube Short',
      create_youtube_post: 'Create YouTube community post',
      write_youtube_description: 'Write YouTube description',
  ...
  buildTaskPrompt(action, platform, params) {
    ...
    const templates = {
      ...
      upload_youtube_video: `Upload a YouTube video about: ${goal || query || 'new content'}`,
      upload_youtube_short: `Upload a YouTube Short about: ${goal || query || 'new content'}`,
      create_youtube_post: `Create a YouTube community post about: ${goal || query || 'new update'}`,
      write_youtube_description: `Write a YouTube description about: ${goal || query || 'the selected video'}`,
