...
function actionsFor(platform, prompt, context = {}) {
  ...
  // Gmail: skip open_target + draft_message — send_message handles everything itself
  if (operation === 'send_message')    return platform === 'gmail' ? ['open_workspace', 'send_message'] : ['open_workspace', 'open_target', 'draft_message', 'send_message'];
  if (operation === 'auto_dm')         return platform === 'gmail' ? ['open_workspace', 'send_message'] : ['open_workspace', 'open_target', 'draft_message', 'send_message'];
  if (operation === 'auto_dm_contact') return platform === 'gmail' ? ['open_workspace', 'send_message'] : ['open_workspace', 'open_target', 'draft_message', 'send_message'];
  if (operation === 'auto_dm_new')     return platform === 'gmail' ? ['open_workspace', 'send_message'] : ['open_workspace', 'open_target', 'draft_message', 'send_message'];
